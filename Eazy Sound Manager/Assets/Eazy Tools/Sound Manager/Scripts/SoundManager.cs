...
public class SoundManager : MonoBehaviour
{
    ...
    /// </summary>
    /// <param name="audioID">The id of the Audio to be returned</param>
    /// <returns>Audio that has as its id the audioID if one is found, null if no such Audio is found</returns>
    ...
    {
        PlayMusic(clip, 1f, false, false, 1f, 1f, -1f);
    }
    ...
    {
        PlayMusic(clip, volume, false, false, 1f, 1f, -1f);
    }
    ...
    public static void PlayMusic(AudioClip clip, bool loop, bool persist)
    {
        PlayMusic(clip, 1f, loop, persist, 1f, 1f, -1f);
    }
    ...
    public static void PlayMusic(AudioClip clip, float volume, bool loop, bool persist)
    {
        PlayMusic(clip, volume, loop, persist, 1f, 1f, -1f);
    }
    ...
    public static void PlayMusic(AudioClip clip, bool loop, bool persist, float fadeInSeconds, float fadeOutSeconds)
    {
        PlayMusic(clip, 1f, loop, persist, fadeInSeconds, fadeOutSeconds, -1f);
    }
    ...
    /// <param name="fadeInValue">How many seconds it needs for the audio to fade in/ reach target volume (if higher than current)</param>
    /// <param name="fadeOutValue"> How many seconds it needs for the audio to fade out/ reach target volume (if lower than current)</param>
    public static void PlayMusic(AudioClip clip, float volume, bool loop, bool persist, float fadeInSeconds, float fadeOutSeconds)
    {
        PlayMusic(clip, volume, loop, persist, fadeInSeconds, fadeOutSeconds, -1f);
    }
    ...
    public static void PlayMusic(AudioClip clip, float volume, bool loop, bool persist, float fadeInSeconds, float fadeOutSeconds, float currentMusicfadeOutSeconds)
    {
        if(clip == null)
        {
        ...
        musicAudio.Add(audioCounter, audio);
        audioCounter++;
    }
    ...
    public static void PlaySound(AudioClip clip, float volume)
    {
        ...
        // Add it to music list
        soundsAudio.Add(audioCounter, audio);
        audioCounter++;
    }
    ...
    /// <param name="clip">The audio clip to play</param>
    /// <param name="volume"> The volume the music will have</param>
    public static void PlayUISound(AudioClip clip, float volume)
    {
        if (clip == null)
        {
            Debug.LogError("Sound Manager: Audio clip is null, cannot play music", clip);
        ...
        // Add it to music list
        UISoundsAudio.Add(audioCounter, audio);
        audioCounter++;
    }
    ...
    public void Update()
    {
        ...
        switch(audioType)
        {
            case AudioType.Music:
                {
                    audioSource.volume = volume * SoundManager.globalMusicVolume;
                    break;
                }
            case AudioType.Sound:
                {
                    audioSource.volume = volume * SoundManager.globalSoundsVolume;
                    break;
                }
            case AudioType.UISound:
                {
                    audioSource.volume = volume * SoundManager.globalUISoundsVolume;
                    break;
                }
        }
